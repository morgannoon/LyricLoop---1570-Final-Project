      ...
      <div className="content-grid">
        <div className="dashboard-card">
          ...
          <p className="card-subtitle">
            Shows overall app performance: user growth, lyric activity, engagement, and trends. Gives
            admins a quick snapshot of how the platform is used and what is popular.
          </p>
          <div className="stats-grid">
            <div className="mini-stat">
              <span className="mini-stat-value">{formatNumber(stats.activeUsers)}</span>
              <span className="mini-stat-label">Active Users (week)</span>
            </div>
            <div className="mini-stat">
            ...
            <div className="mini-stat">
              <span className="mini-stat-value">{formatNumber(stats.totalReports)}</span>
